...
const ITEMS = [
  ...
  { href: "/admin/instructors", label: "認定講師一覧", match: "prefix" as const },
  { href: "/admin/instructor-accounts", label: "会員講師", match: "prefix" as const },
  ...
  { href: "/admin/licenses", label: "ライセンス", match: "prefix" as const },
  { href: "/admin/license", label: "課金ライセンス", match: "exact" as const },
