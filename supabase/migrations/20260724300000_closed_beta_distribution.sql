-- Closed Beta 配布制御
-- Migration: 20260724300000_closed_beta_distribution
-- - profiles.beta_terms_accepted_at … 初回ログイン時の利用規約同意（サーバー永続）
-- - certified_instructors.usage_start_date … 利用開始日（ログインゲート）
